...
/*
 * This class acts as a purchased item list manager. the class represent a customer single purchase (of one or more items) in the cashier
 */
public class PurchaseList 
{
	
	private ArrayList<PurchaseItem> m_purechaseList = new ArrayList<PurchaseItem>();	// an ArrayList to hold the current purchased items
	...
	//prints to a string the purchased list data
